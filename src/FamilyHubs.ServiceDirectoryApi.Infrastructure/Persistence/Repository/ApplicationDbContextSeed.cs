...
//                if (_context != null && _context.Organizations != null && CreateOrOpenReferralOrganisations != null)
//                {
//                    if (!await _context.Organizations.AnyAsync())
//                    {
//                        var OpenReferralOrganisations = CreateOrOpenReferralOrganisations();
//                        await _context.Organizations.AddRangeAsync((IEnumerable<OpenReferralOrganisation>)OpenReferralOrganisations);
