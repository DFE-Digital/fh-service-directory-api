using FamilyHubs.ServiceDirectoryApi.Core.Exceptions;
using FamilyHubs.ServiceDirectoryApi.Core.Infrastructure.Security.Authorisation;
...
public class AuthorisationBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse> where TRequest : IRequest<TResponse> // notnull
{
