...
namespace FamilyHubs.ServiceDirectoryApi.Api.Queries.GetServices;

public class GetOpenReferralServicesQuery : IRequest<PaginatedList<OpenReferralServiceDto>>
{
    public GetOpenReferralServicesQuery() { }
    public GetOpenReferralServicesQuery(string? status, int? minimum_age, int? maximum_age, double? latitude, double? longtitude, double? proximity, int? pageNumber, int? pageSize, string? text)
    {
        Status = status;
...
public class GetOpenReferralServicesCommandHandler : IRequestHandler<GetOpenReferralServicesQuery, PaginatedList<OpenReferralServiceDto>>
{
    private readonly ServiceDirectoryDbContext _context;

    public GetOpenReferralServicesCommandHandler(ServiceDirectoryDbContext context)
    {
        _context = context;
    }
    public async Task<PaginatedList<OpenReferralServiceDto>> Handle(GetOpenReferralServicesQuery request, CancellationToken cancellationToken)
    {
