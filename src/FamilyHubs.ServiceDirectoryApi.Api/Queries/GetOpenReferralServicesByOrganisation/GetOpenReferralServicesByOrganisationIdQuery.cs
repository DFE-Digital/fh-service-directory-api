...
namespace FamilyHubs.ServiceDirectoryApi.Api.Queries.GetOpenReferralServicesByOrganisation;

public class GetOpenReferralServicesByOrganisationIdQuery : IRequest<List<OpenReferralServiceDto>>
{
    public GetOpenReferralServicesByOrganisationIdQuery(string id)
    {
        Id = id;
    }
...
public class GetOpenReferralServicesByOrganisationIdCommandHandler : IRequestHandler<GetOpenReferralServicesByOrganisationIdQuery, List<OpenReferralServiceDto>>
{
    private readonly ServiceDirectoryDbContext _context;

    public GetOpenReferralServicesByOrganisationIdCommandHandler(ServiceDirectoryDbContext context)
    {
        _context = context;
    }

    public async Task<List<OpenReferralServiceDto>> Handle(GetOpenReferralServicesByOrganisationIdQuery request, CancellationToken cancellationToken)
    {
