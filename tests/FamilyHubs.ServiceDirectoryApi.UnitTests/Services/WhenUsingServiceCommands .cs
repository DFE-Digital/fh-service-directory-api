...
public class WhenUsingServiceCommands : BaseCreateDbUnitTest
{
    ...
    public async Task ThenGetOpenReferralService()
    {
        ...
        GetOpenReferralServicesCommand command = new("active", "XTEST", null, null, null, null, null, null, 1, 10, null, null, null, null, null, null);
    ...
    public async Task ThenGetOpenReferralServiceThatArePaidFor()
    {
        ...
        GetOpenReferralServicesCommand command = new("active", "XTEST", null, null, null, null, null, null, 1, 10, null, null, true, null, null, null);
        GetOpenReferralServicesCommandHandler handler = new(mockApplicationDbContext);
    ...
    public async Task ThenGetOpenReferralServiceThatAreFree()
    {
        ...
        GetOpenReferralServicesCommand command = new("active", "XTEST", null, null, null, null, null, null, 1, 10, null, null, false, null, null, null);
        GetOpenReferralServicesCommandHandler handler = new(mockApplicationDbContext);
